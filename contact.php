...
<head>
    ...
    <meta property="og:image:alt" content="MyJobs" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address>DYPCET, Kolhapur</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:myjobs@gmail.com">myjobs@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91 1234567890 ">1234567890</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About MyJobs.Com</h5>
											<p>MyJobs.com is a job portal, online job management system developement project. </p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">MyJobs Contact</h5>
								
								<p>Address : DYPCET, Kolhapur</p>
								<p>Email : <a href="MyJobs@gmail.com">MyJobs@gmail.com</a></p>
								<p>Phone : <a href="tel:+233546607474">+91 1234567890</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> ViV Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Vivek Patil</a></li>
								</ul>
